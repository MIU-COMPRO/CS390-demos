 ...
 * abstract methods
  2. Cannot create an object for the Abstract class
  3. Don't make abstract class constructor as private
  4. Abstract method means no body, must implement in a sub class
...
*/
 abstract public class Book {
	...
	//2. Don't provide implementation / method with no body
	// 3. You have read behaviour with the signature, what to do, provide abstraction
