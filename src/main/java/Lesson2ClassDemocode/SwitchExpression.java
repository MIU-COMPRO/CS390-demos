...
//        System.out.println(STR."Your weight is in the planet \{p} =\{weight}");
   // 2. Replace with new Switch without break
        switch (p) {
            case "venus" -> weight = w * 0.78;
            case "mars" -> weight = w * 0.39;
            case "jupiter" -> weight = w * 2.65;
...
//        System.out.print(STR." and your weight is = \{weight}");
    }
}
